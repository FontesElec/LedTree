...
public class Firework extends AppCompatActivity {
    ...
    public Firework.ConnectedThread threadCommand;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paletteSel.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar)
            {
                ...
                threadCommand.sendCommand(69);//"E" in ASCII                // тема E салют
        ...
        threadCommand = new Firework.ConnectedThread(BluetoothConnection.clientSocket);
        threadCommand.run();
    }
